...
export const ARCHETYPES = [
  {
    ...
    abilities: [
      {
        id: 'postura_blindada',
        name: 'Postura Blindada',
        tag: 'Combate',
        description: 'En postura Prudente, bloqueas 2 puntos de daño extra por cada golpe recibido.',
      },
      {
        id: 'escudo_caravana',
        name: 'Escudo de Caravana',
        tag: 'Expedición',
        description: 'La caravana recibe −1 de daño en cada combate de ruta.',
      },
    ],
  },
  {
    ...
    abilities: [
      {
        ...
        name: 'Recuperación',
        tag: 'Descanso',
        description: 'Al acampar, recuperas 3 puntos de vitalidad adicionales.',
      },
      {
        id: 'aguante',
        name: 'Aguante',
        tag: 'Ruta',
        description: 'Ignoras el primer evento de daño de ruta por jornada de marcha.',
      },
    ],
  },
  {
    ...
    abilities: [
      {
        ...
        name: 'Sello Arcano',
        tag: 'Combate',
        description: 'En postura Equilibrada, tu primer ataque de combate inflige 3 daño adicional.',
      },
      {
        id: 'descifrar',
        name: 'Descifrar',
        tag: 'Exploración',
        description: 'Al examinar ruinas, desbloqueas eventos secretos ocultos para otros arquetipos.',
      },
    ],
  },
  {
    ...
    abilities: [
      {
        ...
        name: 'Atajo',
        tag: 'Ruta',
        description: 'Una vez por expedición, descubres una ruta alternativa que omite un encuentro peligroso.',
      },
      {
        id: 'emboscada',
        name: 'Emboscada',
        tag: 'Combate',
        description: 'Puedes iniciar combate en postura Audaz sin recibir el penalizador de sorpresa.',
      },
    ],
  },
]
...
export const WORLD_ROUTE_BRANCHES = [
  {
    id:              'branch_bells_after_seg_afm_07',
    routeId:         'route_aethel_to_mist',
    afterSegmentId:  'seg_afm_07',
    name:            'Campanas sordas',
    description:     'Un sonido metálico llega desde dos galerías distintas. Una cornisa cubierta de musgo baja hacia una zona de descanso. Un paso estrecho de campanas huecas atraviesa una galería más corta y peligrosa.',
    options: [
      {
        id:          'branch_bells_left_moss_cornice',
        side:        'left',
        label:       'Izquierda',
        name:        'Cornisa de musgo negro',
        shortName:   'Cornisa de musgo',
        description: 'Una cornisa ancha y húmeda, cubierta de musgo oscuro. El camino es más largo, pero estable y con posibilidad de descanso.',
        knownDescription: 'Ya conoces la cornisa. El musgo señala el camino y los puntos de apoyo son firmes.',
        pros:        ['Posible descanso', 'Menos amenaza', 'Más seguridad para la criatura'],
        cons:        ['Más pasos', 'Menos XP'],
        risk:        'low',
        rewardStyle: 'rest',
        stepModifier:        0.12,
        threatModifier:     -0.20,
        resourceModifier:    0.02,
        discoveryModifier:   0,
        restChanceModifier:  0.20,
        secretChanceModifier: 0,
        visual: { pathVariant: 'lower-moss', colorHint: 'safe', icon: 'moss' },
      },
      {
        id:          'branch_bells_right_hollow_bells',
        side:        'right',
        label:       'Derecha',
        name:        'Paso de campanas huecas',
        shortName:   'Campanas huecas',
        description: 'Un pasadizo resonante con campanas antiguas colgadas de las grietas. Más corto, pero algo se mueve al ritmo del metal.',
        knownDescription: 'Conoces el ritmo de las campanas. Sabes cuándo detenerte y cuándo avanzar.',
        pros:        ['Menos pasos', 'Más XP', 'Posible evento raro'],
        cons:        ['Mucha amenaza', 'Posible combate', 'Sin descanso'],
        risk:        'high',
        rewardStyle: 'combat',
        stepModifier:        -0.10,
        threatModifier:       0.30,
        resourceModifier:     0.08,
        discoveryModifier:    0.10,
        restChanceModifier:  -0.12,
        secretChanceModifier: 0.08,
        visual: { pathVariant: 'upper-bells', colorHint: 'danger', icon: 'bell' },
      },
    ],
  },
  {
    id:              'branch_roots_split_after_seg_afm_03',
    routeId:         'route_aethel_to_mist',
    afterSegmentId:  'seg_afm_03',
    name:            'Raíces partidas',
    description:     'El camino se divide bajo una bóveda de raíces. A la izquierda, una senda estrecha protege del viento. A la derecha, una grieta oscura conserva faroles rotos.',
    options: [
      {
        id:          'branch_roots_split_left_low_root',
        side:        'left',
        label:       'Izquierda',
        name:        'Paso bajo la raíz',
        shortName:   'Bajo la raíz',
        description: 'Una senda estrecha bajo una raíz gigante. Incómoda, pero alejada del viento y las amenazas del exterior.',
        knownDescription: 'Ya conoces el paso. Las marcas de farol que dejaste siguen visibles sobre la raíz.',
        pros:        ['Menos amenaza', 'Menos pasos', 'Más posibilidad de descanso'],
        cons:        ['Menos recursos', 'Menos hallazgos raros'],
        risk:        'low',
        rewardStyle: 'safe',
        stepModifier:        -0.12,
        threatModifier:      -0.18,
        resourceModifier:    -0.08,
        discoveryModifier:   -0.05,
        restChanceModifier:   0.10,
        secretChanceModifier: -0.03,
        visual: { pathVariant: 'lower-root', colorHint: 'safe', icon: 'root' },
      },
      {
        id:          'branch_roots_split_right_broken_lanterns',
        side:        'right',
        label:       'Derecha',
        name:        'Grieta de los faroles rotos',
        shortName:   'Faroles rotos',
        description: 'Una grieta más profunda donde los faroles antiguos aparecen partidos. Promete mejores hallazgos, pero algo se mueve dentro.',
        knownDescription: 'Ya cruzaste la grieta. Reconoces las marcas de hollín y sabes dónde no pisar.',
        pros:        ['Más recursos', 'Posible secreto', 'Más dominio si se completa'],
        cons:        ['Más amenaza', 'Más pasos', 'Posible combate'],
        risk:        'medium',
        rewardStyle: 'resource',
        stepModifier:         0.18,
        threatModifier:       0.22,
        resourceModifier:     0.18,
        discoveryModifier:    0.08,
        restChanceModifier:  -0.05,
        secretChanceModifier: 0.12,
        visual: { pathVariant: 'upper-crack', colorHint: 'danger', icon: 'broken-lantern' },
      },
    ],
  },
]
